  ...
  [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
  {
    variants: {
      variant: {
        ...
        aria-expanded:bg-muted aria-expanded:text-foreground dark:border-input dark:bg-input/30
        ...
        focus-visible:border-destructive/40 focus-visible:ring-destructive/20 dark:bg-destructive/20
